# payload-contract-structure

Static reads of an n8n workflow for payload-contract: which paths expressions touch, guards, lineage through Set and Code nodes.
